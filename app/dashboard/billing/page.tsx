    ...
    return (
        <div className="space-y-12 max-w-6xl mx-auto pb-20 p-4 md:p-8">
            ...
            <div className="text-center">
                <div className="inline-block px-3 py-1 border border-[#e3ee42]/30 bg-[#e3ee42]/5 text-[#e3ee42] text-[10px] font-black uppercase tracking-[0.2em] mb-6 rounded-sm">
                    Subscription Matrices
                </div>
                <h2 className="text-4xl md:text-5xl font-black uppercase text-[#e0e2ec] mb-4 tracking-tight">
                    Scaling <span className="font-poppins font-semibold text-[#e3ee42] glow-text">DMPRO.in</span> Infrastructure
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch pt-6">
                ...
                <div className="steam-card p-8 flex flex-col relative overflow-hidden group rounded-sm border border-transparent">
                    ...
                    <ul className="space-y-4 mb-10 flex-1">
                        <li className="flex items-start gap-3">
                            <CheckCircle2 className="w-4.5 h-4.5 text-[#e3ee42] shrink-0 mt-0.5" />
                ...
                <div className="steam-card pro-highlight p-8 flex flex-col relative overflow-hidden scale-105 z-10 rounded-sm">
                    {/* Most Popular Badge */}
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#e3ee42] px-4 py-1 rounded-sm shadow-sm">
                        <span className="text-[#303300] text-[9px] font-black uppercase tracking-tighter">Most Popular</span>
                    </div>
                    <div className="absolute top-0 right-0 p-4 opacity-20 pointer-events-none">
                        <Zap className="w-16 h-16 text-[#e3ee42]" />
                    </div>
                    <div className="mt-4 mb-8">
                        <h3 className="text-[12px] font-bold text-[#e3ee42] glow-text uppercase tracking-widest mb-2">Pro Velocity</h3>
                        <div className="flex items-baseline gap-1">
                    ...
                    <div className="industrial-divider mb-8 bg-[#e3ee42]/20"></div>
                    
                    <ul className="space-y-4 mb-10 flex-1">
                        <li className="flex items-start gap-3">
                            <CheckCircle2 className="w-4.5 h-4.5 text-[#e3ee42] shrink-0 mt-0.5 fill-[#e3ee42]/10" />
                    ...
                    <button className="w-full py-4 bg-[#e3ee42] hover:brightness-110 text-[#1b1d00] font-black uppercase tracking-widest text-xs shadow-[0_0_20px_rgba(199,209,35,0.4)] active:scale-[0.98] transition-all cursor-pointer border-none">
                        Deploy Pro
                    </button>
                </div>
            ...
            <div className="mt-16 flex flex-col items-center gap-8">
                <button className="text-[#e3ee42] hover:underline text-[12px] font-black uppercase tracking-wider flex items-center gap-2 cursor-pointer">
