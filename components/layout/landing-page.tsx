    ...
    <div className="min-h-screen bg-[#10131a] text-[#e0e2ec] overflow-x-hidden selection:bg-primary/20 relative">
      ...
      <main className="pt-16 pb-24 relative z-10 max-w-7xl mx-auto">
        ...
        <section className="px-4 md:px-8 mb-20 max-w-5xl mx-auto">
          ...
          <div className="steam-card p-6 border border-[#272a31] rounded-none">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="flex items-center gap-2 text-[10px] text-foreground font-bold uppercase tracking-wider">
                <span className="text-primary">✓</span> Official Meta integration
              </div>
              <div className="flex items-center gap-2 text-[10px] text-foreground font-bold uppercase tracking-wider">
                <span className="text-primary">✓</span> Customer-controlled automation
              </div>
              <div className="flex items-center gap-2 text-[10px] text-foreground font-bold uppercase tracking-wider">
                <span className="text-primary">✓</span> Secure account connection
              </div>
              <div className="flex items-center gap-2 text-[10px] text-foreground font-bold uppercase tracking-wider">
                <span className="text-primary">✓</span> Privacy-focused design
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="px-4 md:px-8 mb-20 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              { step: "01", title: "Connect Instagram Business Account", desc: "Securely link your Instagram Business account using official Meta authentication." },
              { step: "02", title: "Configure Automation Rules", desc: "Configure automation rules for comments, DMs, and story mentions based on your preferences." },
              { step: "03", title: "Enable Automated Engagement", desc: "Activate your workflows to start engaging with customers automatically." },
              { step: "04", title: "Monitor Conversations & Performance", desc: "Track conversations and performance metrics from your dashboard." }
            ].map((p, i) => (
        ...
        <section className="px-4 md:px-8 mb-20 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              { step: "03", title: "Smart Responses", desc: "Users configure automated reply workflows and messaging templates for customer engagement." },
        ...
        <section className="bg-[#1d2027]/50 px-4 md:px-8 py-16 border-y border-[#272a31] max-w-5xl mx-auto mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h5 className="text-xs font-bold text-foreground uppercase tracking-wider mb-1">Message Storage Policy</h5>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h5 className="text-xs font-bold text-foreground uppercase tracking-wider mb-1">User Account Control</h5>
        ...
        <section className="px-4 md:px-8 mb-20 max-w-5xl mx-auto">
          ...
          <p className="text-[11px] text-muted-foreground leading-relaxed mb-6 max-w-2xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="steam-card p-4 border border-[#272a31] rounded-none text-center">
              ...
              <h4 className="text-[10px] font-bold text-foreground uppercase tracking-wider mt-2">Official Meta Authentication</h4>
            </div>
            <div className="steam-card p-4 border border-[#272a31] rounded-none text-center">
              <span className="text-primary text-lg font-bold">✓</span>
              <h4 className="text-[10px] font-bold text-foreground uppercase tracking-wider mt-2">User-authorized Account Access</h4>
            </div>
            <div className="steam-card p-4 border border-[#272a31] rounded-none text-center">
              <span className="text-primary text-lg font-bold">✓</span>
              <h4 className="text-[10px] font-bold text-foreground uppercase tracking-wider mt-2">Customer-controlled Automation</h4>
            </div>
            <div className="steam-card p-4 border border-[#272a31] rounded-none text-center">
              <span className="text-primary text-lg font-bold">✓</span>
              <h4 className="text-[10px] font-bold text-foreground uppercase tracking-wider mt-2">Privacy-first Design</h4>
            </div>
          </div>
        </section>
        ...
        */}
        ...
        <section className="px-4 md:px-8 py-20 text-center max-w-2xl mx-auto">
          <div className="steam-card p-10 rounded-none border border-[#272a31] relative overflow-hidden">
            ...
            <p className="text-xs text-muted-foreground mb-8 leading-relaxed">Secure setup using official Meta authentication.<br/>Connect your account and configure automations in minutes.</p>
            <button
              onClick={handleLogin}
        ...
        <footer className="px-4 md:px-8 py-8 border-t border-[#272a31] text-center max-w-5xl mx-auto">
          <p className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] mb-6">DMPro is a product of Sudexhub.</p>
          <div className="flex justify-center gap-6 flex-wrap mb-6">
            <a className="text-[10px] text-muted-foreground hover:text-primary transition-colors font-bold uppercase tracking-wider" href="#">About Sudexhub</a>
            ...
            <a className="text-[10px] text-muted-foreground hover:text-primary transition-colors font-bold uppercase tracking-wider" href="#">Data Deletion Instructions</a>
          </div>
          <p className="text-[9px] text-muted-foreground/60 uppercase tracking-[0.2em]">© 2024 Sudexhub. All rights reserved.</p>
        </footer>
      </main>
    </div>
  )
